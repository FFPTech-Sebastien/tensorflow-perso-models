...
export default function App() {
    ...
    const processImagePrediction = async (model, tensor) => {
        const prediction = await model.predict(tensor.reshape([-1, INPUT_TENSOR, INPUT_TENSOR, 3]));
        console.log(prediction.argMax(2).dataSync());
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <TensorCamera
                ...
                resizeDepth={3}
                resizeHeight={INPUT_TENSOR}
                resizeWidth={INPUT_TENSOR}
                autorender
